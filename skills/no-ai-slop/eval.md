...
8. Was every explanatory tail cut rather than shortened, so no sentence merely restates, justifies, or draws the moral of the one before it?
9. Does every generic sentence pass the portability test, or was it cut or made specific to this subject?
10. Does the draft use active voice with human subjects where possible?
11. Does the edit keep useful edge and preserve structure unless the structure was hurting the piece?
12. Are genuinely tangled sentences fixed while clear spoken cadence, fragments, and changes in pace remain intact?
...
4a. Were headings, section labels, bold lead-ins, table headers and list stems edited too, not just the prose under them, including rhetorical-question headings rewritten to carry their answer?
...
7. Are summary-recap endings and engagement bait cut so the piece ends on a concrete point, takeaway, or next action?
